...
exports.salvar = function(encomenda, cb) {
    ...
    if (encomenda.formaPgto && encomenda.formaPgto == 'ENT+1' && encomenda.dataEntrada) {
        ...
        statements[statements.length] = {
            ...
            params: ['Recebimento', `Entrada da venda de ${encomenda.desc}`, 'C', encomenda.dataEntrada, encomenda.entradaPgto.valueOf()], 
            cb: (err) => {
                if (err) {
    ...
    statements[statements.length] = {
        ...
        params: [encomenda.desc, encomenda.tipoProduto, encomenda.qtde, encomenda.cores, encomenda.obs, encomenda.dataPrevista, encomenda.dataEncomenda, 
            ...
            encomenda.formaPgto, entrada, encomenda.dataEntrada, valor, encomenda.dataPgto, encomenda.statusPgto], 
        cb: (err) => {
            if (err) {
...
exports.atualizar = function(encomenda, cb) {
    ...
    statements[statements.length] = {
        ...
        params: [encomenda.desc, encomenda.tipoProduto, encomenda.qtde, encomenda.cores, encomenda.obs, encomenda.dataPrevista, encomenda.dataEncomenda, 
            ...
            encomenda.nomeCliente, encomenda.telCliente, encomenda.emailCliente, encomenda.cepEndCliente, encomenda.logEndCliente, 
            encomenda.numEndCliente, encomenda.bairroEndCliente, encomenda.compEndCliente, encomenda.ufEndCliente, encomenda.cidEndCliente, 
            encomenda.formaPgto, encomenda.entradaPgto.valueOf(), encomenda.dataEntrada, encomenda.valorPgto.valueOf(), encomenda.dataPgto, 
            encomenda.statusPgto, encomenda.id], 
        cb: (err) => {
            if (err) {
